...
import com.example.quizapp.databinding.QuizMaths2Binding

class QuizMathsSB : AppCompatActivity() {
    private lateinit var binding: QuizMaths2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizMaths2Binding.inflate(layoutInflater)
