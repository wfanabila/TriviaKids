...
import com.example.quizapp.databinding.QuizMaths1Binding

class QuizMaths : AppCompatActivity() {
    private lateinit var binding: QuizMaths1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = QuizMaths1Binding.inflate(layoutInflater)
    ...
    private fun checkAnswer(selectedAnswerIndex: Int) {
        ...
        if (currentQuestionIndex < questions.size - 1) {
            ...
            stopStopwatch()
            binding.questionText.postDelayed({
                val intent = Intent(this, QuizMathsSB::class.java)
